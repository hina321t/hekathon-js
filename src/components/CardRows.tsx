...
const CardsRows = () => {
  return (
    <div className="w-[90%] mx-auto flex justify-between items-start gap-6">
      ...
      <div className="bg-white shadow-lg rounded-lg p-4 w-1/3 hover:bg-slate-300">
        {/* Image */}
        <Image src="/five.png" alt="Card 1" width={150} height={150} className="object-contain" />

        {/* Name and Icon */}
        <div className="flex items-center mt-4">
          <h3 className="font-bold text-lg">Sarah M.</h3>
          <Image src="/right.png" alt="Icon" width={20} height={20} />
        </div>
      ...
      <div className="bg-white shadow-lg rounded-lg p-4 w-1/3 hover:bg-slate-300">
        {/* Image */}
        <Image src="/five.png" alt="Card 2" width={150} height={150} className="object-contain" />
      ...
      <div className="bg-white shadow-lg rounded-lg p-4 w-1/3 hover:bg-slate-300">
        {/* Image */}
        <Image src="/five.png" alt="Card 3" width={150} height={150} className="object-contain" />
